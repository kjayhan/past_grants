...
#set page(
  ...
  numbering: "1",
  number-align: right,
  // Running header — hidden on page 1 (pg > 1, but I make it 0 for now)
  header: context {
    ...
    if pg > 0 {
      stack(
        ...
        grid(
          ...
          text(font: "Jost", size: 8.5pt, weight: 500,
               fill: c-purple)[$title$],
          text(font: "Jost", size: 8.5pt,
  ...
  footer: context {
    ...
    if pg > 0 {
      stack(
        ...
        line(length: 100%, stroke: 0.4pt + c-gray-light),
        align(center,
          text(font: "Jost", size: 7.5pt,
               fill: c-gray-medium)[JMU Office of Research Development - researchdevelopment\@jmu.edu]
        )
      )
    }
  }
...
// ────────────────────────────────────────────────────────────
#show heading: set text(font: "Jost", fill: c-purple)
...
// H3 – italic, normal weight, 112.5%
#show heading.where(level: 3): it => {
  v(1.1em, weak: true)
  text(size: 1em, weight: 500, style: "italic")[#it]
  v(0.3em, weak: true)
}
...
$if(title)$
#text(font: "Jost", size: 2.4em, weight: 700, fill: c-purple)[
  $title$
]
#v(0.35em)
...
$if(subtitle)$
#text(font: "Jost", size: 1.3em, weight: 400, fill: c-gold-dark)[
  $subtitle$
]
#v(0.5em)
$endif$
...
$if(by-author)$
#text(font: "Jost", size: 1.05em, weight: 500, fill: c-gray-dark)[
...
$if(date)$
#text(font: "Jost", size: 0.9em, fill: c-gray-medium)[
  $date$
]
#v(0.25em)
$endif$
...
#block(
  ...
  #text(font: "Jost", size: 0.88em, weight: 600, fill: c-purple)[Abstract]
  #v(0.35em)
...
$if(toc)$
#outline(
  title: text(font: "Jost", weight: 600, fill: c-purple)[Contents],
  indent: 1.5em,
  depth: $toc-depth$,
)
#pagebreak()
