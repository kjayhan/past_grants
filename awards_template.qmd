...
# For now let's limit ourselves to projects that begin with "Collaborative Research" in their titles. Remove or uncomment this line if you don't want to filter anything based on title.
...
# Some awards are collaborative projects. This code aggregates the amount for collaborative projects.
